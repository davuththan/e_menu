...
<div class="box box-info">
	@include('common.error')
	 <!-- form start -->
	@if( isset($entity) )
		{!! Form::model($entity,['method' => 'PATCH','id'=>'form','class'=>'form-horizontal','files'=>true,'route'=>['admin.cmgr.career.update',$entity->id]]) !!}
  	@else
  		{!! Form::open(['url' => 'admin/cmgr/career','id'=>'form','class'=>'form-horizontal','files'=>true]) !!}
  	@endif
  <div class="box-header with-border">
   <button type="submit"  class="btn btn-info pull-left" validation-submit="Form">Save</button> &nbsp;
    <a href="{{url('admin/cmgr/career')}}" class="btn btn-default">List</a>
    <a href="{{url('admin/cmgr/career')}}" class="btn btn-default pull-right">Back</a>
  </div><!-- /.box-header -->
    <div class="box-body">
      <div class="col-sm-9">
	      ...
	      <div class="form-group">
	        <label class="col-sm-4 control-label">Report To <span class="text-danger">*</span></label>
	        <div class="col-sm-8">
	          {!! Form::text('report_to',null,['class'=>'form-control']) !!}
	        </div>
	      </div>
	      <div class="form-group">
