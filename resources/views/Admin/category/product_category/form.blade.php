          ...
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              @if(!isset($product_category))
                {!! Form::open(['url' => 'admin/category/product_category','files'=> true,'class'=>'form-horizontal']) !!}
              @else
                {!! Form::model($product_category,['method' => 'PATCH','class'=>'form-horizontal','files'=> true,'route'=>['admin.category.product_category.update',$product_category->id]]) !!}
              @endif
              	...
              	<div class="with-border box-header">
	               ...
	               <div class="pull-right">
		               <span>
			               ...
			               <a class="btn btn-default" href ="{{url('admin/category/product_category')}}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div style="position:relative;">
                        ...
                        <div class="e-logo">
                          @if(isset($product_category))
                            <input type="hidden" value="{{$product_category->icon}}" name="icon_hidden">
                            @if($product_category->icon!='') 
                              <img width="50px" src="{{url('images/upload/icon')}}/{{$product_category->icon}}" id="t" />
                            @else
