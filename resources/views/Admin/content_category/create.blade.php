        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              ...
              {!! Form::open(['url' => 'admin/content_category','class'=>'form-horizontal']) !!}
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        {!! Form::checkbox('is_active', 1, true,['class'=>'form-control', 'style'=>'width:40px']) !!}
                      </div>
                    </div>
                    ...
                    <div id="tabs">
                      ...
                      <div id="{{$lang->code}}">
                        <div class="form-group">
                          <label  class="col-sm-4 control-label"><img src="{{$lang->image}}" height="20" alt="{{$lang->name}}" /> Name <span class="validate_label_red">*</span></label>
                          <div class="col-sm-8">
