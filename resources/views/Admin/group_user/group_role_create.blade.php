        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              ...
              {!! Form::open(['url' => 'admin/user_mgr/group_role','class'=>'form-horizontal']) !!}
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                      <label  class="col-sm-4 control-label">Group Role name<span class="validate_label_red">*</span></label>
                      <div class="col-sm-4">
