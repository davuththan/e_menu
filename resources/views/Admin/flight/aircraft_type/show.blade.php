        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              {!! Form::model($data,['method' => 'PATCH','class'=>'form-horizontal','route'=>['admin.fmgr.f_aircraft_type.update',$data->id]]) !!}
                <div class="with-border box-header">
                 <h3 class="box-title">{!!$view_title!!} Form</h3>
                 <div class="pull-right">
                   <span>
                     <a class="btn btn-default" href ="{{url('admin/fmgr/f_aircraft_type')}}">
