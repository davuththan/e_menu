              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
	                ...
	                @foreach ($EventCategory as $event_category)
                      ...
                      <td>{{url('')}}/event/{{ $event_category->id}}</td>
	                    <td width="250">
	                      <a href="{{route('admin.event_mgr.event_category.show',$event_category->id)}}" class="btn btn-info"> <i class="fa fa-info"></i> </a>
	                    
	                      <a href="{{route('admin.event_mgr.event_category.edit',$event_category->id)}}" class="btn btn-primary" title="Edit"><i class="fa fa-pencil"></i></a>
			                
		                     <a href="{{route('admin.event_mgr.event_category.destroy',$event_category->id)}}" class="btn btn-danger" title="Delete" data-method="delete" data-confirm="Are you sure?">
