          ...
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              @if($action=='Edit' || $action=='View')
                <!-- !! Form::model($EventCategorys,['files'=> true,'class'=>'form-horizontal','route'=>['admin.event_mgr.event_category.update',$EventCategorys->id]]) !!} -->
                  ...
                  <div id="tabs">
                    ...
                    <div id="{{$lang->code}}">
                      <div class="form-group">
                        <label  class="col-sm-4 control-label"><img src="{{SITE_HTTP_URL.$lang->image}}" height="20" alt="{{$lang->name}}" /> {!!trans('event_mgr/event_category.event_category')!!} <span class="validate_label_red">*</span></label>
                        <div class="col-sm-8">
                          {!! Form::text('name_'.$lang->id,$name,['class'=>'form-control ckeditor','placeholder'=>'Description']) !!}
                        </div>
                      </div>
