        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              ...
              <!-- !! Form::open(['url' => 'admin/cmgr/slide','class'=>'form-horizontal','id'=>'msform']) !!} -->
              {!! Form::open(['url' => 'admin/cmgr/slide','files'=> true,'class'=>'form-horizontal','id'=>'msform']) !!}
                        ...
                        <div class="col-sm-4">
                          ...
                          <div style="position:relative;">
                            ...
                            <div class="e-logo">
                                ...
                                <!-- <input type="file" name="image" value="" id="image" accept="image/x-png, image/gif, image/jpeg"  /> -->
                      ...
                      <div id="tabs">
                        ...
                        <div id="{{$lang->code}}">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              {!! Form::text('title[]',null,['class'=>'form-control','placeholder'=>'Title Article']) !!}
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              {!! Form::text('sub_title[]',null,['class'=>'form-control','placeholder'=>'Sub Title Article']) !!}
                            </div>
                          </div>
