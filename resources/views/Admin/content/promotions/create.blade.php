        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              ...
              {!! Form::open(['url' => 'admin/cmgr/promotions','files'=> true,'class'=>'form-horizontal','id'=>'msform']) !!}
                  ...
                  <div class="box-body">
                      ...
                      <div class="form-group">
                        <label  class="col-sm-4 control-label">Thumbnail (Size: W 570px, H 380px)<span class="validate_label_red">*</span></label>
                        <div class="col-sm-4">
                      ...
                      <div id="tabs">
                        ...
                        <div id="{{$lang->code}}">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              {!! Form::text('title[]'.$lang->id,null,['class'=>'form-control ckeditor','placeholder'=>'Title']) !!}
                            </div>
                          </div>
