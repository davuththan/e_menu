                 ...
                 @include('Admin.common.error_input')
                  <div class="box-body">
                      ...
                      <div class="form-group">
                        <label  class="col-sm-4 control-label">Thumbnail (Size: W 40px, H 29px)<span class="validate_error">*</span></label>
                        ...
                        <div class="col-sm-4">
                          ...
                          <div style="position:relative;">
                            <!--e-logo-->
                            <div class="e-logo">
                              @if($quick_link->thumbnail!='')
                                <img style="background-color:#2196F3;" src="{{url('/images/uploads/quick_link')}}/{{$quick_link->thumbnail}}" id="t" />
