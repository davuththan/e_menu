        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              ...
              {!! Form::open(['url' => 'admin/cmgr/quick_link','files'=> true,'class'=>'form-horizontal','id'=>'msform']) !!}
                  ...
                  <div class="box-body">
                      ...
                      <div class="form-group">
                        <label  class="col-sm-4 control-label">Thumbnail (Size: W 40px, H 29px)<span class="validate_label_red">*</span></label>
                        <div class="col-sm-4">
