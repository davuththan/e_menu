                  ...
                  <div class="box-body">
                    ...
                    <div id="tabs">
                      ...
                      <div id="{{$lang->code}}">
                        ...
                        <div class="form-group">
                          <div class="col-sm-12">
                             <img src="{{SITE_HTTP_URL.$lang->image}}" height="20" alt="{{$lang->name}}" /> Description<br />
                        ...
                        <div class="form-group">
                          <div class="col-sm-12"><img src="{{SITE_HTTP_URL.$lang->image}}" height="20" alt="{{$lang->name}}" /> Meta Keywords<br />
                        ...
                        <div class="form-group">
                          <div class="col-sm-12"><img src="{{SITE_HTTP_URL.$lang->image}}" height="20" alt="{{$lang->name}}" /> Meta Description<br />
