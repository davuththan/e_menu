        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              {!! Form::model($vision_mission,['method' => 'PATCH','files'=> true,'class'=>'form-horizontal','route'=>['admin.cmgr.vision_mission.update',$vision_mission->id]]) !!}
                <div class="with-border box-header">
                 ...
                 <div class="pull-right">
                   <span>
                     ...
                     <a class="btn btn-default" href ="{{url('admin/cmgr/vision_mission')}}">
                 ...
                 @include('Admin.common.error_input')
                  <div class="box-body">
                          ...
                          <div style="position:relative;">
                            ...
                            <div class="e-logo">
                              @if($vision_mission->image!='')
                                <img src="{{url('/images/uploads/vison_mission')}}/{{$vision_mission->image}}" id="t" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="checkbox" name="is_active" <?php if($vision_mission->is_active==1) echo "checked=''";?> value="1" class="form-control" style="width:40px;">
                        </div>
                      </div>
