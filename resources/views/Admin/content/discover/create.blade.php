        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              ...
              {!! Form::open(['url' => 'admin/cmgr/discover','files'=> true,'class'=>'form-horizontal','id'=>'msform']) !!}
                  ...
                  <div class="box-body">
                      ...
                      <div class="form-group">
                        <label  class="col-sm-4 control-label">Image (Size: W 897px, H 411px)<span class="validate_label_red">*</span></label>
                        <div class="col-sm-4">
