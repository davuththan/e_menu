        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              {!! Form::model($discover,['method' => 'PATCH','files'=> true,'class'=>'form-horizontal','route'=>['admin.cmgr.discover.update',$discover->id]]) !!}
                <div class="with-border box-header">
                 ...
                 <div class="pull-right">
                   <span>
                     ...
                     <a class="btn btn-default" href ="{{url('admin/cmgr/discover')}}">
                 ...
                 @include('Admin.common.error_input')
                  <div class="box-body">
                      ...
                      <div class="form-group">
                        <label  class="col-sm-4 control-label">Image (Size: W 897px, H 411px)<span class="validate_error">*</span></label>
                        ...
                        <div class="col-sm-4">
                          ...
                          <div style="position:relative;">
                            ...
                            <div class="e-logo">
                              @if($discover->image!='')
                                <img src="{{url('/images/uploads/discover')}}/{{$discover->image}}" id="t" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="checkbox" name="is_active" <?php if($discover->is_active==1) echo "checked=''";?> value="1" class="form-control" style="width:40px;">
                        </div>
                      </div>
