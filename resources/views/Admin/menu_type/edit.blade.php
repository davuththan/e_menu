        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              ...
              {!! Form::model($menu_type,['method' => 'PATCH','class'=>'form-horizontal','route'=>['admin.menu_mgr.mtype.update',$menu_type->id]]) !!}
              	...
              	<div class="with-border box-header">
	               ...
	               <div class="pull-right">
		               <span>
			               ...
			               <a class="btn btn-default" href ="{{url('admin/menu_type')}}">
