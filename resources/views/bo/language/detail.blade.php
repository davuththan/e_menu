...
<div class="box box-info">
	@include('common.error')
	 <!-- form start -->
	@if( isset($entity) )
		{!! Form::model($entity,['method' => 'PATCH','id'=>'form','class'=>'form-horizontal','files'=>true,'route'=>['admin.cmgr.language.update',$entity->id]]) !!}
  	@else
  		{!! Form::open(['url' => 'admin/cmgr/language','id'=>'form','class'=>'form-horizontal','files'=>true]) !!}
  	@endif
  <div class="box-header with-border">
   <button type="submit"  class="btn btn-info pull-left" validation-submit="Form">Save</button> &nbsp;
    <a href="{{url('admin/cmgr/language')}}" class="btn btn-default">List</a>
    <a href="{{url('admin/cmgr/language')}}" class="btn btn-default pull-right">Back</a>
  </div><!-- /.box-header -->
    <div class="box-body">
      <div class="col-sm-9">
      ...
      <div class="col-sm-2">
      	@if( isset($entity) )
      		<img id="image_preview" class="img-responsive" alt="image-preview" 
      		src="{{url($entity->image)}}">
      		<!-- <img id="image_preview" class="img-responsive" alt="image-preview" src="{{url('$entity->image')}}"> -->
      	@else
