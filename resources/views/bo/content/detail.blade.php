...
<div class="box box-info">
	@include('common.error')
	 <!-- form start -->
	@if( isset($entity) )
		{!! Form::model($entity,['method' => 'PATCH','id'=>'form','class'=>'form-horizontal','files'=>true,'route'=>['admin.cmgr.content.update',$entity->id]]) !!}
  	@else
  		{!! Form::open(['url' => 'admin/cmgr/content','id'=>'form','class'=>'form-horizontal','files'=>true]) !!}
  	@endif
  <div class="box-header with-border">
   <button type="submit"  class="btn btn-info pull-left" validation-submit="Form">Save</button> &nbsp;
    <a href="{{url('admin/cmgr/content')}}" class="btn btn-default">List</a>
    <a href="{{url('admin/cmgr/content')}}" class="btn btn-default pull-right">Back</a>
  </div><!-- /.box-header -->
    <div class="box-body">
      <div class="col-sm-9">
	      	<div class="form-group">
		        ...
		        <div class="col-sm-8">
		          ...
		          {!! Form::select('category_id',array_merge([null => 'Select Group'] + $categories),null,['class'=>'form-control']) !!}
		        </div>
	      </div>
	      	<div class="form-group">
