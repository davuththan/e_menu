...
namespace App\Http\Controllers\Admin;
    ...
    class BannerController extends Controller {
        ...
        public $view_title = "Design <small> >> Banner</small>";
        ...
        {   
            return view('Admin.design.banner.form')
                                    ->with('view_title',$this->view_title)
                                    ->with('action',"Create");
        }
        ...
        if ($validator->fails()) {
          ...
          return redirect()->back()->withInput()->withErrors($validator);
            ...
            if (Input::file('image')->isValid()) {
                ...
                $destinationPath = 'images/upload/banner/'.$date_create; // upload path
               ...
               return redirect('admin/design/banner')->with('message','Save Successfully');
            }else {
              // sending back with error message.
              Session::flash('error', 'Problem while uploading file!');
              //return Redirect::to('upload');
              return redirect('admin/design/banner/create')
        ...
        public function show($id)
        {
            ...
            return view('Admin.design.banner.form')->with('view_title',$this->view_title)
                                                ->with('Banners',$Banners)
                                                ->with('action',"View");
        }
        ...
        return redirect('admin/design/banner')->with('message','Update Successfully');
