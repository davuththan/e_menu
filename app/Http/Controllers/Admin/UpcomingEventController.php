...
class UpcomingEventController extends Controller
{
	...
	public $view_title = "Event Management <small> >> Upcoming Events</small>";
    ...
    {   
        ...
        return view('Admin.event_mgr.upcoming_event.index')
    ...
    {
        $Events = Position::find($id);
        return view('Admin.event_mgr.upcoming_event.form')->with('Events',$Events)
                            ->with('view_title',$this->view_title)
                            ->with('action',"View");
    }
