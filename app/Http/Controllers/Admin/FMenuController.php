...
class FMenuController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // if(Input::file('attach_file')=='') $input['attach_file'] = $input['attach_file_hidden'];
        ...
        if (Input::file('attach_file')!='') {
            ...
            if( $v->passes() ) {
              ...
              $destinationPath = 'images/upload/general/'.$date_create; 
    ...
    public function destroy($id)
    {
        ...
        $this->ActivityLog();
        //
        $data=FMenuModel::find($id)->delete();
        DB::table('fmenu_description')->Where('fmenu_id',$id)->delete();
