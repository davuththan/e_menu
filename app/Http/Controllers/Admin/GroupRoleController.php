...
class GroupRoleController extends Controller {
	...
	public function index()
	{
		...
		return view('Admin.group_user.group_role_index')
	...
	public function show($id)
	{
        ...
        $group_id = $id;
        $permissionOnMenu = $this->permissionOnMenu($group_id,$language_id=2);

		return view('Admin.group_user.group_role_permission')
